    ...
    <div className="py-10 bg-cover">
      ...
      >
        ...
        <div className="relative p-10 flex justify-center flex-col w-full items-center">
          <span className="bg-sky-500 px-2 text-gray-50 rounded-md">
            {post.tags}
          </span>
          ...
          <div className="w-full flex flex-col justify-center items-center gap-4 text-gray-50">
            <Image
              ...
              width={300}
              height={300}
              className="rounded-full w-40 h-40 object-cover border-sky-500 border-4 mt-5"
            />
      ...
      <div className="wrapper mt-10 text-gray-900 dark:text-white flex flex-col gap-5">
        <p>{post.paragraph}</p>
        <p>{post.paragraph}</p>
        <p>{post.paragraph}</p>
        <p>{post.paragraph}</p>
